...
public class InstructionsPane extends BorderPane {
    ...
    public InstructionsPane(Stage stage) {
        ...
        String strGameOptions2 = "\t\to The game will be played by the user and 1 to 3 computer units:\n\t\t\t- 1v1 (2 players) \n\t\t\t- 1v1v1 (3 players)\n\t\t\t- 1v1v1v1 (4 players)";
